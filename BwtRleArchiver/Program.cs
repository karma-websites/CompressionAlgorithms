...
namespace BwtRleArchiver;

internal class Program
{
    private static void Main()
    {
        Console.WriteLine("Archiver: RLE + BWT + RLE");
    ...
    private static void CompressFile(string dataFileName, string archFileName)
    {
        ...
        Console.WriteLine($"{"Data size to read from file: ",-50} {data.Length} byte. \tWorking time: {stopwatch.ElapsedMilliseconds} ms");
        ...
        stopwatch.Restart();
        byte[] arch = Rle.Compress(bwtData);
        stopwatch.Stop();
        Console.WriteLine($"{"RLE size data: ",-50} {arch.Length} byte. \tWorking time: {stopwatch.ElapsedMilliseconds} ms");
    ...
    private static void DecompressFile(string archFileName, string dataFileName)
    {
        ...
        stopwatch.Restart();
        byte[] bwtData = Rle.Decompress(arch);
        Console.WriteLine($"{$"Inverse RLE size data: ",-50} {bwtData.Length} byte. \tWorking time: {stopwatch.ElapsedMilliseconds} ms");
